...
class ClassForm(FlaskForm):
    ...
    price = DecimalField(_l('Price'), validators=[Optional()], default=0.0)
    billing_rate = DecimalField(_l('Billing Rate'), validators=[Optional()], default=0.0)
    payrate = DecimalField(_l('Pay Rate'), validators=[Optional()], default=0.0)
